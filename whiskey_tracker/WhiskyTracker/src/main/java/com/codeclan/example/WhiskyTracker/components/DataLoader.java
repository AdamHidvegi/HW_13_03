...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Distillery distillery5 = new Distillery("TestName", "Speyside");
        distilleryRepository.save(distillery5);

        Whisky whisky5 = new Whisky("TestWhisky", 12, 1995, distillery5);
        whiskyRepository.save(whisky5);

        Distillery distillery6 = new Distillery("TestName", "TestRegion");
        distilleryRepository.save(distillery6);

        Whisky whisky6 = new Whisky("TestWhiskyTest", 14, 1992, distillery6);
        whiskyRepository.save(whisky6);

        Whisky whisky7 = new Whisky("WhiskyWhisky", 14, 1982, distillery6);
